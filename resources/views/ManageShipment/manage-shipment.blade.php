...
@section('content')
    ...
    <div
        ...
        class="shadow-card w-full rounded-sm bg-white pb-2"
    >
        <div>
            <h1
                class="relative z-9 mb-3 w-full rounded-tl-sm rounded-tr-sm bg-warnaBiruTua p-3 text-xs font-semibold text-warnaKuning bp400:text-sm xl:text-base 2xl:text-lg"
            >
                Manage Shipment
            </h1>
        ...
        @if (request()->is('manage-shipment/pending'))
            <x-ManageShipment.manage-shipment-pending></x-ManageShipment.manage-shipment-pending>
        @elseif (request()->is('manage-shipment/on-progress'))
            <x-ManageShipment.manage-shipment-on-progress></x-ManageShipment.manage-shipment-on-progress>
        @elseif (request()->is('manage-shipment/completed'))
            <x-ManageShipment.manage-shipment-completed></x-ManageShipment.manage-shipment-completed>
        @elseif (request()->is('manage-shipment/rejected'))
            <x-ManageShipment.manage-shipment-rejected></x-ManageShipment.manage-shipment-rejected>
        @elseif (request()->is('manage-shipment/cancel'))
            <x-ManageShipment.manage-shipment-cancel></x-ManageShipment.manage-shipment-cancel>
        @endif
    </div>
@endsection
