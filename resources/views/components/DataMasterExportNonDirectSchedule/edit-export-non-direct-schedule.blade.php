<form
    action="{{ route('dm-export-non-direct-schedule.update', ['slug' => $exportNon['slug']]) }}"
    method="post"
        ...
        <div class="flex w-full flex-col gap-3">
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('destination', $exportNon['destination']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('voyage', $exportNon['voyage']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    name="etd_origin"
                    id="etd_origin"
                    value="{{ old('etd_origin', $exportNon['etd_origin']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('ves_connecting', $exportNon['ves_connecting']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('connecting_city', $exportNon['connecting_city']) }}"
                    required
                />
            </div>
        </div>
        ...
        <div class="flex w-full flex-col gap-3">
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('vessel', $exportNon['vessel']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    name="stf/cls"
                    id="stf/cls"
                    value="{{ old('stf/cls', $exportNon['stf/cls']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    id="eta_destination"
                    value="{{ old('eta_destination', $exportNon['eta_destination']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    class="{{ $errors->has('voy_connecting') ? 'outline-red-400' : 'outline-transparent' }} shadow-input w-full rounded-sm p-[6px] outline-2 transition-all duration-300 ease-in-out focus:outline-warnaBiruTua"
                    type="text"
                    name="voy_connecting"
                    id="voy_connecting"
                    placeholder="Input Voy Connecting"
                    value="{{ old('voy_connecting', $exportNon['voy_connecting']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    id="etd_destination"
                    value="{{ old('etd_destination', $exportNon['etd_destination']) }}"
                    required
                />
            </div>
        </div>
