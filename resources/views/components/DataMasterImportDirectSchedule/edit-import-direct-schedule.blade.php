<form
    action="{{ route('dm-import-direct-schedule.update', ['slug' => $import['slug']]) }}"
    method="post"
...
>
        ...
        <div class="flex w-full flex-col gap-3">
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('destination', $import['destination']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('voyage', $import['voyage']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    name="etd_origin"
                    id="etd_origin"
                    value="{{ old('etd_origin', $import['etd_origin']) }}"
                    required
                />
            </div>
        </div>
        ...
        <div class="flex w-full flex-col gap-3">
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('vessel', $import['vessel']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    name="stf/cls"
                    id="stf/cls"
                    value="{{ old('stf/cls', $import['stf/cls']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    id="eta_destination"
                    value="{{ old('eta_destination', $import['eta_destination']) }}"
                    required
                />
            </div>
        </div>
    ...
    >
        <a
            ...
            href="/dm-import-direct-schedule"
        >
            ❮ Return
        </a>
        <button
