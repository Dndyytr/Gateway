<div class="flex w-full justify-between gap-1 px-3">
    <div class="flex gap-2 whitespace-nowrap">
        <a
            ...
            href="/dm-import-direct-schedule/create"
        >
            + New
        </a>
        <a
            ...
            href="/dm-import-direct-schedule/import"
        >
...
<div
    x-data="{
        ...
        deleteUrl: 'dm-import-direct-schedule.destroy',
        openDeleteModal(url) {
            this.deleteUrl = url
...
>
    <table class="table-data table-fixed" id="dm-import-direct-schedule-table">
        <thead>
            <tr>
                <th class="pr-5 md:w-[23%]">Destination</th>
                <th class="pr-5 md:w-[20%]">Vessel</th>
                <th class="pr-5 md:w-[20%]">Voyage</th>
                <th class="pr-5 md:w-[20%]">STF/CLS</th>
                <th class="pr-5 md:w-[23%]">ETD Origin</th>
                <th class="pr-5 md:w-[23%]">ETA Destination</th>
                <th class="text-right md:w-[30%]">Actions</th>
            </tr>
        </thead>
        <tbody></tbody>
    </table>
        ...
        >
            ...
            >
                ...
                <p class="text-center font-medium text-stone-700">
                    Are you sure you want to delete this Import Direct Schedule? This action cannot be undone.
                </p>
            </div>
            <div
...
<script defer>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        $(document).ready(function () {
            if ($('#dm-import-direct-schedule-table').length) {
                const table = $('#dm-import-direct-schedule-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: '{{ route('dm-import-direct-schedule.data') }}',
                    ...
                    createdRow: function (row, data, dataIndex) {
                        const headers = $('#dm-import-direct-schedule-table thead th')
                            .map(function () {
                    ...
                    drawCallback: function (settings) {
                        ...
                        if (table.rows({ search: 'applied' }).count() === 0) {
                            const $tbody = $('#dm-import-direct-schedule-table tbody');
                            $tbody.empty();
                            $tbody.append(
                                $('<tr>').append(
                                    $('<td>')
                    ...
                    initComplete: function () {
                        $('table#dm-import-direct-schedule-table colgroup').remove();
                        $(
                            '#dm-import-direct-schedule-table_wrapper #dm-import-direct-schedule-table_processing',
                        ).remove();
