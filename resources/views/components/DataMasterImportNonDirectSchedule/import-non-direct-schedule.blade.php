<div class="flex w-full justify-between gap-1 px-3">
    <div class="flex gap-2 whitespace-nowrap">
        <a
            ...
            href="/dm-import-non-direct-schedule/create"
        >
            + New
        </a>
        <a
            ...
            href="/dm-import-non-direct-schedule/import"
        >
...
<div
    x-data="{
        ...
        deleteUrl: 'dm-import-non-direct-schedule.destroy',
        openDeleteModal(url) {
            this.deleteUrl = url
...
>
    <table
        ...
        class="table-data"
        id="dm-import-non-direct-schedule-table"
    >
        <thead>
            <tr>
        ...
        >
            ...
            >
                ...
                <p class="text-center font-medium text-stone-700">
                    Are you sure you want to delete this Import Non Direct Schedule? This action cannot be undone.
                </p>
            </div>
            <div
...
<script defer>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $(document).ready(function () {
            if ($('#dm-import-non-direct-schedule-table').length) {
                const table = $('#dm-import-non-direct-schedule-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: '{{ route('dm-import-non-direct-schedule.data') }}',
                    ...
                    createdRow: function (row, data, dataIndex) {
                        const headers = $('#dm-import-non-direct-schedule-table thead th')
                            .map(function () {
                    ...
                    drawCallback: function (settings) {
                        ...
                        if (table.rows({ search: 'applied' }).count() === 0) {
                            const $tbody = $('#dm-import-non-direct-schedule-table tbody');
                            $tbody.empty();
                            $tbody.append(
                                $('<tr>').append(
                                    $('<td>')
                    ...
                    initComplete: function () {
                        $('table#dm-import-non-direct-schedule-table colgroup').remove();
                        $(
                            '#dm-import-non-direct-schedule-table_wrapper #dm-import-non-direct-schedule-table_processing',
                        ).remove();
