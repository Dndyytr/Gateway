<div class="w-full px-3">
    ...
    >
        <a class="w-full rounded-[3px] bg-warnaBiruTua px-3 py-1 text-white" href="">PENDING</a>
        <a
...
<div class="m-3 rounded-[3px] border-[1.5px] border-stone-300 px-3 py-2 font-medium">
    ...
    >
        <table
            ...
            class="table-data"
            id="manage-shipment-pending-table"
        >
            <thead>
                <tr>
            ...
            >
                ...
                >
                    ...
                    <p class="text-center font-medium text-stone-700">
                        Are you sure you want to reject this Manage Shipment Pending? This action cannot be undone.
                    </p>
                </div>
                <div
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        $(document).ready(function () {
            ...
            if ($('#manage-shipment-pending-table').length) {
                ...
                const table = $('#manage-shipment-pending-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: '{{ route('manage-shipment.pending.data') }}',
                    ...
                    createdRow: function (row, data, dataIndex) {
                        const headers = $('#manage-shipment-pending-table thead th')
                            .map(function () {
                    ...
                    drawCallback: function (settings) {
                        ...
                        if (table.rows({ search: 'applied' }).count() === 0) {
                            const $tbody = $('#manage-shipment-pending-table tbody');
                            $tbody.empty();
                            $tbody.append(
                                $('<tr>').append(
                                    $('<td>')
                    ...
                    initComplete: function () {
                        $('table#manage-shipment-pending-table colgroup').remove();
                        $('#manage-shipment-pending-table_wrapper #manage-shipment-pending-table_processing').remove();
