<form
    ...
    action="{{ route('dm-users.update', ['slug' => $user['slug']]) }}"
    method="post"
    ...
    <div class="flex w-full flex-col gap-2 sm:flex-row">
        ...
        >
            ...
            <input
                ...
                value="{{ old('person_in_charge', $user['pic']) }}"
                required
            />
            {{-- email address --}}
            ...
            <input
                ...
                name="nib_number"
                id="nib_number"
                value="{{ old('nib_number', $user['NIB_number']) }}"
            ...
            <input
                ...
                name="photo_of_npwp"
                accept="image/*"
                value="{{ old('photo_of_npwp', $user['photo_of_npwp']) }}"
            ...
            <input
                ...
                value="{{ old('company_legality', $user['company_legality_nib']) }}"
                accept="image/*"
