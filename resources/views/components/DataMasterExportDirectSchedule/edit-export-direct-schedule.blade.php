<form
    action="{{ route('dm-export-direct-schedule.update', ['slug' => $export['slug']]) }}"
    method="post"
...
>
        ...
        <div class="flex w-full flex-col gap-3">
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('destination', $export['destination']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('voyage', $export['voyage']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    name="etd_origin"
                    id="etd_origin"
                    value="{{ old('etd_origin', $export['etd_origin']) }}"
                    required
                />
            </div>
        </div>
        ...
        <div class="flex w-full flex-col gap-3">
            ...
            >
                ...
                <input
                    ...
                    value="{{ old('vessel', $export['vessel']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    name="stf/cls"
                    id="stf/cls"
                    value="{{ old('stf/cls', $export['stf/cls']) }}"
                    required
                />
            </div>
            <div
            ...
            >
                ...
                <input
                    ...
                    id="eta_destination"
                    value="{{ old('eta_destination', $export['eta_destination']) }}"
                    required
                />
            </div>
        </div>
    ...
    >
        <a
            ...
            href="/dm-export-direct-schedule"
        >
            ❮ Return
        </a>
        <button
