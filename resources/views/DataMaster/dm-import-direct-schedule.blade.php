...
@section('content')
    @php
        if (request()->is('dm-import-direct-schedule*')) {
    ...
    >
        ...
        @if (request()->is('dm-import-direct-schedule'))
            <x-DataMasterImportDirectSchedule.import-direct-schedule></x-DataMasterImportDirectSchedule.import-direct-schedule>
        @elseif (request()->is('dm-import-direct-schedule/create'))
            <x-DataMasterImportDirectSchedule.create-import-direct-schedule></x-DataMasterImportDirectSchedule.create-import-direct-schedule>
        @elseif (request()->is('dm-import-direct-schedule/*/edit'))
            <x-DataMasterImportDirectSchedule.edit-import-direct-schedule
                :import="$import"
            ></x-DataMasterImportDirectSchedule.edit-import-direct-schedule>
        @elseif (request()->is('dm-import-direct-schedule/import'))
            <x-DataMasterImportDirectSchedule.import-import-direct-schedule></x-DataMasterImportDirectSchedule.import-import-direct-schedule>
        @endif
    </div>
@endsection
