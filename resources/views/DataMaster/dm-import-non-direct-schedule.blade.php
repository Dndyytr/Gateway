...
@section('content')
    @php
        if (request()->is('dm-import-non-direct-schedule*')) {
    ...
    >
        ...
        @if (request()->is('dm-import-non-direct-schedule'))
            <x-DataMasterImportNonDirectSchedule.import-non-direct-schedule></x-DataMasterImportNonDirectSchedule.import-non-direct-schedule>
        @elseif (request()->is('dm-import-non-direct-schedule/create'))
            <x-DataMasterImportNonDirectSchedule.create-import-non-direct-schedule></x-DataMasterImportNonDirectSchedule.create-import-non-direct-schedule>
        @elseif (request()->is('dm-import-non-direct-schedule/*/edit'))
            <x-DataMasterImportNonDirectSchedule.edit-import-non-direct-schedule
                :importNon="$importNon"
            ></x-DataMasterImportNonDirectSchedule.edit-import-non-direct-schedule>
        @elseif (request()->is('dm-import-non-direct-schedule/import'))
            <x-DataMasterImportNonDirectSchedule.import-import-non-direct-schedule></x-DataMasterImportNonDirectSchedule.import-import-non-direct-schedule>
        @endif
    </div>
@endsection
