...
@section('content')
    ...
    >
        ...
        @if (request()->is('dm-users'))
            <x-DataMasterUsers.users></x-DataMasterUsers.users>
        @elseif (request()->is('dm-users/create'))
            <x-DataMasterUsers.create-users></x-DataMasterUsers.create-users>
        @elseif (request()->is('dm-users/*/edit'))
            <x-DataMasterUsers.edit-users :user="$user"></x-DataMasterUsers.edit-users>
        @endif
    </div>
@endsection
