...
@section('content')
    ...
    >
        ...
        @if (request()->is('dm-port'))
            <x-DataMasterPort.port></x-DataMasterPort.port>
        @elseif (request()->is('dm-port/create'))
            <x-DataMasterPort.create-port></x-DataMasterPort.create-port>
        @elseif (request()->is('dm-port/*/edit'))
            <x-DataMasterPort.edit-port :port="$port"></x-DataMasterPort.edit-port>
        @endif
    </div>
@endsection
