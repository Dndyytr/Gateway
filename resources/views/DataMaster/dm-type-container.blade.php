...
@section('content')
    @php
        if (request()->is('dm-type-container*')) {
    ...
    >
        ...
        @if (request()->is('dm-type-container'))
            <x-DataMasterTypeContainer.type-container></x-DataMasterTypeContainer.type-container>
        @elseif (request()->is('dm-type-container/create'))
            <x-DataMasterTypeContainer.create-type-container></x-DataMasterTypeContainer.create-type-container>
        @elseif (request()->is('dm-type-container/*/edit'))
            <x-DataMasterTypeContainer.edit-type-container
                :type="$type"
            ></x-DataMasterTypeContainer.edit-type-container>
        @endif
    </div>
