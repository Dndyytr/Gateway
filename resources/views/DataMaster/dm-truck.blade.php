...
@section('content')
    ...
    >
        ...
        @if (request()->is('dm-truck'))
            <x-DataMasterTruck.truck></x-DataMasterTruck.truck>
        @elseif (request()->is('dm-truck/create'))
            <x-DataMasterTruck.create-truck></x-DataMasterTruck.create-truck>
        @elseif (request()->is('dm-truck/*/edit'))
            <x-DataMasterTruck.edit-truck :truck="$truck"></x-DataMasterTruck.edit-truck>
        @endif
    </div>
@endsection
