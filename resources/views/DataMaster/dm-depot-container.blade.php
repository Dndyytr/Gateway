...
@section('content')
    @php
        if (request()->is('dm-depot-container*')) {
    ...
    >
        ...
        @if (request()->is('dm-depot-container'))
            <x-DataMasterDepotContainer.depot-container></x-DataMasterDepotContainer.depot-container>
        @elseif (request()->is('dm-depot-container/create'))
            <x-DataMasterDepotContainer.create-depot-container></x-DataMasterDepotContainer.create-depot-container>
        @elseif (request()->is('dm-depot-container/*/edit'))
            <x-DataMasterDepotContainer.edit-depot-container
                :depot="$depot"
            ></x-DataMasterDepotContainer.edit-depot-container>
        @endif
    </div>
