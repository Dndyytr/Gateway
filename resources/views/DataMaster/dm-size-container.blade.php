...
@section('content')
    @php
        if (request()->is('dm-size-container*')) {
    ...
    >
        ...
        @if (request()->is('dm-size-container'))
            <x-DataMasterSizeContainer.size-container></x-DataMasterSizeContainer.size-container>
        @elseif (request()->is('dm-size-container/create'))
            <x-DataMasterSizeContainer.create-size-container></x-DataMasterSizeContainer.create-size-container>
        @elseif (request()->is('dm-size-container/*/edit'))
            <x-DataMasterSizeContainer.edit-size-container
                :size="$size"
            ></x-DataMasterSizeContainer.edit-size-container>
        @endif
    </div>
