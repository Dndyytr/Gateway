...
@section('content')
    ...
    >
        ...
        @if (request()->is('dm-access-role'))
            <x-DataMasterAccessRole.access-role></x-DataMasterAccessRole.access-role>
        @elseif (request()->is('dm-access-role/create'))
            <x-DataMasterAccessRole.create-access-role></x-DataMasterAccessRole.create-access-role>
        @elseif (request()->is('dm-access-role/*/edit'))
            <x-DataMasterAccessRole.edit-access-role :role="$role"></x-DataMasterAccessRole.edit-access-role>
        @elseif (request()->is('dm-access-role/*/permissions'))
            <x-DataMasterAccessRole.permissions-access-role :role="$role" :permissions="$permissions" :menuMap="$menuMap"></x-DataMasterAccessRole.permissions-access-role>
        @endif
    </div>
@endsection
