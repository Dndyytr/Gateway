...
@section('content')
    ...
    >
        ...
        @if (request()->is('dm-banner'))
            <x-DataMasterBanner.banner></x-DataMasterBanner.banner>
        @elseif (request()->is('dm-banner/create'))
            <x-DataMasterBanner.create-banner></x-DataMasterBanner.create-banner>
        @elseif (request()->is('dm-banner/*/edit'))
            <x-DataMasterBanner.edit-banner :banner="$banner"></x-DataMasterBanner.edit-banner>
        @endif
    </div>
@endsection
