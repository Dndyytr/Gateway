...
@section('content')
    @php
        if (request()->is('dm-export-non-direct-schedule*')) {
            $titleMain = match (request()->path()) {
                default => $titleMain ?? ucfirst('Title Not Found'),
            };
        }
    ...
    >
        ...
        @if (request()->is('dm-export-non-direct-schedule'))
            <x-DataMasterExportNonDirectSchedule.export-non-direct-schedule></x-DataMasterExportNonDirectSchedule.export-non-direct-schedule>
        @elseif (request()->is('dm-export-non-direct-schedule/create'))
            <x-DataMasterExportNonDirectSchedule.create-export-non-direct-schedule></x-DataMasterExportNonDirectSchedule.create-export-non-direct-schedule>
        @elseif (request()->is('dm-export-non-direct-schedule/*/edit'))
            <x-DataMasterExportNonDirectSchedule.edit-export-non-direct-schedule
                :exportNon="$exportNon"
            ></x-DataMasterExportNonDirectSchedule.edit-export-non-direct-schedule>
        @elseif (request()->is('dm-export-non-direct-schedule/import'))
            <x-DataMasterExportNonDirectSchedule.import-export-non-direct-schedule></x-DataMasterExportNonDirectSchedule.import-export-non-direct-schedule>
        @endif
    </div>
@endsection
