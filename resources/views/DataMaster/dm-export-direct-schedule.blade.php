...
@section('content')
    @php
        if (request()->is('dm-export-direct-schedule*')) {
    ...
    >
        ...
        @if (request()->is('dm-export-direct-schedule'))
            <x-DataMasterExportDirectSchedule.export-direct-schedule></x-DataMasterExportDirectSchedule.export-direct-schedule>
        @elseif (request()->is('dm-export-direct-schedule/create'))
            <x-DataMasterExportDirectSchedule.create-export-direct-schedule></x-DataMasterExportDirectSchedule.create-export-direct-schedule>
        @elseif (request()->is('dm-export-direct-schedule/*/edit'))
            <x-DataMasterExportDirectSchedule.edit-export-direct-schedule
                :export="$export"
            ></x-DataMasterExportDirectSchedule.edit-export-direct-schedule>
        @elseif (request()->is('dm-export-direct-schedule/import'))
            <x-DataMasterExportDirectSchedule.import-export-direct-schedule></x-DataMasterExportDirectSchedule.import-export-direct-schedule>
        @endif
    </div>
@endsection
