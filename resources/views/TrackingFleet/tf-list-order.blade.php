...
@section('content')
    ...
    >
        ...
        @if (request()->routeIs('tf-list-order.index'))
            <x-TrackingFleetListOrder.list-order :tfListOrders="$tfListOrders"></x-TrackingFleetListOrder.list-order>
        @elseif (request()->routeIs('tf-list-order.show'))
            <x-TrackingFleetListOrder.detail-order :orders="$orders"></x-TrackingFleetListOrder.detail-order>
        @endif
    </div>
@endsection
