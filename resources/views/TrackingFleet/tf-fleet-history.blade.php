...
@section('content')
    @php
        if (request()->is('tf-fleet-history*')) {
    ...
    >
        ...
        @if (request()->routeIs('tf-fleet-history.index'))
            <x-TrackingFleetFleetHistory.fleet-history
                :tfFleetHistories="$tfFleetHistories"
            ></x-TrackingFleetFleetHistory.fleet-history>
        @elseif (request()->routeIs('tf-fleet-history.show'))
            <x-TrackingFleetFleetHistory.detail-fleet :fleets="$fleets"></x-TrackingFleetFleetHistory.detail-fleet>
        @endif
    </div>
@endsection
